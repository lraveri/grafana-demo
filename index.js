...
async function main() {
  ...
  logger.warn({ requestId: randomUUID(), clientId: 'demo-client-01', window: '1m', used: 92, limit: 100 }, 'rate limit nearing');
  ...
  logger.warn({ requestId: randomUUID(), sql: 'select * from line_items where order_id = $1', params: [5012], dbDurationMs: 213, thresholdMs: 200 }, 'slow query detected');
  ...
  logger.warn({ requestId: randomUUID(), node: 'api-01', filesystem: '/dev/disk3s1s1', percentUsed: 91 }, 'disk space low');
  ...
  logger.warn({ requestId: randomUUID(), clientId: 'client-77', window: '5m', used: 495, limit: 500 }, 'rate limit nearing');
  ...
  logger.warn({ requestId: randomUUID(), durationMs: 4800, thresholdMs: 3000 }, 'report generation slow');
  ...
  logger.warn({ requestId: randomUUID(), disk: '/', percentUsed: 92, node: 'api-02' }, 'disk space low');
